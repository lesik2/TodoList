...
import { CategoriesWrapper, CategoryItem, CategoryText, ChooseText, IconWrapper, Wrapper, WrapperButton } from "./styled";
      ...
      
        {
          ...
          <CategoriesWrapper style={styles.boxShadow}>
            ...
            {categories.map((category, index)=>(
              <CategoryItem key={index}  onPress={handleChooseCategory(category)}>
                <CategoryText>
                  {category}
                </CategoryText>
            </CategoryItem>
